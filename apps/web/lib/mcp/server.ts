...
// domain (people/teams/recipes/…); OpsBoard fans out by domain too:
// ./tools/opsboard.ts (the 14 mission/task data tools) and ./tools/research.ts
// (the 5 research-delegate tools wrapping the AI Research engine). Keep the
// route depending only on this function so adding/removing tool modules never
// touches the handler.
